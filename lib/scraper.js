(function () {
  ...
  function scrapStation(arr) {
    ...
    // coordinates
    station.lat = arr[0].substr(18,10);
    station.lon = arr[1].substr(1,10);

    // general description
    station.id = clear(arr[4]);
    ...
    station.units = clear(arr[7]);
    station.capacity = clear(arr[8]);
